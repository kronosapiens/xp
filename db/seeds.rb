...
#Creating some tags
@frontend = Tag.create(:active => true, :name => "Front-End", :category => "topic")
@rails = Tag.create(:active => true, :name => "Rails", :category => "topic")
@testing = Tag.create(:active => true, :name => "Testing", :category => "topic")
@databases = Tag.create(:active => true, :name => "Databases", :category => "topic")
@random_fun = Tag.create(:active => true, :name => "Random Fun", :category => "topic")

@ruby = Tag.create(:active => true, :name => "Ruby", :category => "language")
@javascript = Tag.create(:active => true, :name => "JavaScript", :category => "language")
@css = Tag.create(:active => true, :name => "CSS", :category => "language")
@sql = Tag.create(:active => true, :name => "SQL", :category => "language")
@objective_c = Tag.create(:active => true, :name => "Objective-C", :category => "language")
@python = Tag.create(:name => "Python", :category => "language")
@php = Tag.create(:name => "PHP", :category => "language")

@morning = Tag.create(:active => true, :name => "Morning", :category => "time")
@afternoon = Tag.create(:active => true, :name => "Afternoon", :category => "time")
@evening = Tag.create(:active => true, :name => "Evening", :category => "time")
@monday = Tag.create(:active => true, :name => "Monday", :category => "time")
@tuesday = Tag.create(:active => true, :name => "Tuesday", :category => "time")
@wednesday = Tag.create(:active => true, :name => "Wednesday", :category => "time")
@thursday = Tag.create(:active => true, :name => "Thursday", :category => "time")
@friday = Tag.create(:active => true, :name => "Friday", :category => "time")
@saturday = Tag.create(:active => true, :name => "Saturday", :category => "time")
@sunday = Tag.create(:active => true, :name => "Sunday", :category => "time")

@flatiron = Tag.create(:active => true, :name => "Flatiron Campus", :category => "location")
@manhattan = Tag.create(:active => true, :name => "Manhattan", :category => "location")
@brooklyn = Tag.create(:active => true, :name => "Brooklyn", :category => "location")
@queens = Tag.create(:active => true, :name => "Queens", :category => "location")
@bronx = Tag.create(:active => true, :name => "The Bronx", :category => "location")
@staten = Tag.create(:active => true, :name => "Staten Island", :category => "location")
@remote = Tag.create(:active => true, :name => "Remote", :category => "location")
